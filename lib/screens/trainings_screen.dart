...
class _TrainingsScreenState extends State<TrainingsScreen> {
  ...
  Future<void> _loadSettings(int trainingIndex) async {
    ...
    setState(() {
      ...
      _controllers["Spin"]?.text = (prefs.getInt("Trainings_Spin_$trainingIndex") ?? 0).toString();
  ...
  Future<void> _saveSettings(int trainingIndex) async {
    ...
    await prefs.setInt("Trainings_Spin_$trainingIndex", int.parse(_controllers["Spin"]!.text));
